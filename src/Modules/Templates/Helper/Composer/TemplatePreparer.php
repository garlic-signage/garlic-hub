...
class TemplatePreparer
{
	...
	public function replace(int $templateId, int $itemId = 0, $playlistId = 0): array
	{
		$templateComposer = [
			...
			'LANG_OPACITY' => $this->translator->translate('opacity', 'templates'),
			'LANG_REDO' => $this->translator->translate('redo', 'main'),
			'LANG_SHADOW' => $this->translator->translate('shadow', 'templates'),
			'LANG_SHADOW_COLOR' => $this->translator->translate('shadow_color', 'templates'),
			...
			'LANG_SCALE_X' => $this->translator->translate('scale_x', 'templates'),
			'LANG_SCALE_Y' => $this->translator->translate('scale_y', 'templates'),
			'LANG_FONT_SIZE' => $this->translator->translate('font_size', 'templates'),
			...
			'LANG_HISTORY' => $this->translator->translate('history', 'main'),
